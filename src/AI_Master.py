...
class AI_Master(object):
    ...
    def __init__(self):
        ...
        with open('data\heat_map_1') as openfileobject:
    ...
    def find_open_space(self, user_board, point):
        ...
        max_ship_key = max(self.ships_remaining.iteritems(), key=operator.itemgetter(1))[0]
        max_ship_size = self.ships_remaining[max_ship_key]
